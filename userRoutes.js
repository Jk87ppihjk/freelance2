...
router.get('/feed', authMiddleware, async (req, res) => {
    ...
    try {
        // Inclui a contagem de comentários no feed
...
// --------------------------------------------------
// 4. NOVA Rota de Adicionar Comentário (POST /api/posts/:postId/comments)
// --------------------------------------------------
...
// --------------------------------------------------
// 5. NOVA Rota para Buscar Comentários (GET /api/posts/:postId/comments)
// --------------------------------------------------
